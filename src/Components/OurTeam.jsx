            ...
            {members.map((member, index) => (
              ...
              >
                <div className="absolute flex flex-col bottom-0 w-full h-full bg-white bg-opacity-60 text-center p-7 font-semibold tracking-wider max-h-[100px] hover:max-h-full transition-all duration-700 hover:rounded-t-xl">
                  <h2 className="text-lg text-center uppercase pl-[.7em]">
                    {member.name}
                  </h2>
                  <p className="text-md text-center uppercase mt-[7px] text-pink-600">
                    {member.title}
                  </p>
                  <p className="mt-[20px] leading-[24px] text-center tracking-[.025em]">
                    {member.description}
                  </p>
